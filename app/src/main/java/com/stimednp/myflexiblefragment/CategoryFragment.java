package com.stimednp.myflexiblefragment;
...
public class CategoryFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_detail_category){
            ...
            mBundle.putString(DetailCategoryFragment.EXTRA_NAME, "LIFE STYLEESS(dgn Bundle)");
            String desc = "Ini Kategori (dgn get+set)";
